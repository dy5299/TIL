...
서버와 데이터를 교환하는 기술 중 하나로, 비동기적인 웹 애플리케이션의 제작을 위한 웹 개발 기법입니다. AJAX는 하나의 기술이 아니라 아래와 같이 함께 사용하는 기술의 묶음을 의미합니다.
...
페이지 단위 컨셉을 제거시키고, 필요한 일부분만 갱신할 수 있도록 XML HttpRequest 객체를 통해 서버에 요청합니다.

비동기방식: thread 요청 시키기. 나는 계속 작업을 요청할 수 있으니까

AJAX를 사용하여 개발하는 입장에서는 server, client 모두 개발해야 합니다.
